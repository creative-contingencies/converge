...
/**
 * Do some preprocessing and show the number of results.
 */

 $total = db_result(db_query("SELECT COUNT(nid) FROM {node} WHERE type='proposal'"));
 $header = '<h3>Showing ' . count($view->result) . ' proposals (Total ' . $total . ')</h3>';
